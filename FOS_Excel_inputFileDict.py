...
def inputFileDict():
	inputFileDict={
		...
		'1_hcrOverall.csv':{
			...
			'outputFileName':'FOS_hcrOverallOut.xlsx',
...
#-----------------------------------------------------------------------------------------
		'1_hcrRtn.csv':{
			...
			'outputFileDir':'//hke.local/hma/Dept/Customer_Satisfaction/Service Business Development/Service Business Improvement/_Programs and Vendors/MSXi/_PDPI/Reports/FOS_Trend_Timeline/dataSource',
			'outputFileSheet':['Sheet 1'],
			'outputFileName':'FOS_hcrRtn.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultKeyGroupBy':['CONSULTANT','DIST','NATL','RegionCode','yyyyMM'],
...
#-----------------------------------------------------------------------------------------
		'1_hcrTimely.csv':{
			...
			'outputFileDir':'//hke.local/hma/Dept/Customer_Satisfaction/Service Business Development/Service Business Improvement/_Programs and Vendors/MSXi/_PDPI/Reports/FOS_Trend_Timeline/dataSource',
			'outputFileSheet':['Sheet 1'],
			'outputFileName':'FOS_hcrTimely.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultKeyGroupBy':['CONSULTANT','DIST','NATL','RegionCode','yyyyMM'],
...
#-----------------------------------------------------------------------------------------
		'1_hcrTimeliness.csv':{
			...
			'outputFileDir':'//hke.local/hma/Dept/Customer_Satisfaction/Service Business Development/Service Business Improvement/_Programs and Vendors/MSXi/_PDPI/Reports/FOS_Trend_Timeline/dataSource',
			'outputFileSheet':['Sheet 1'],
			'outputFileName':'FOS_hcrTimeliness.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultKeyGroupBy':['CONSULTANT','DIST','NATL','RegionCode','yyyyMM'],
...
'1_hcrRecBrnd.csv':{
			...
			'outputFileDir':'//hke.local/hma/Dept/Customer_Satisfaction/Service Business Development/Service Business Improvement/_Programs and Vendors/MSXi/_PDPI/Reports/FOS_Trend_Timeline/dataSource',
			'outputFileSheet':['Sheet 1'],
			'outputFileName':'FOS_hcrRecBrnd.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultKeyGroupBy':['CONSULTANT','DIST','NATL','RegionCode','yyyyMM'],
...
#-----------------------------------------------------------------------------------------
		'1_hcrValue.csv':{
			...
			'outputFileDir':'//hke.local/hma/Dept/Customer_Satisfaction/Service Business Development/Service Business Improvement/_Programs and Vendors/MSXi/_PDPI/Reports/FOS_Trend_Timeline/dataSource',
			'outputFileSheet':['Sheet 1'],
			'outputFileName':'FOS_hcrVal.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultKeyGroupBy':['CONSULTANT','DIST','NATL','RegionCode','yyyyMM'],
...
#-----------------------------------------------------------------------------------------
		'2_gpSales.csv':{
			...
			'outputFileDir':'//hke.local/hma/Dept/Customer_Satisfaction/Service Business Development/Service Business Improvement/_Programs and Vendors/MSXi/_PDPI/Reports/FOS_Trend_Timeline/dataSource',
			'outputFileSheet':['Sheet 1'],
			'outputFileName':'FOS_gpSales.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
...
#-----------------------------------------------------------------------------------------
		'2_rtnCmc.csv':{
			...
			'outputFileDir':'//hke.local/hma/Dept/Customer_Satisfaction/Service Business Development/Service Business Improvement/_Programs and Vendors/MSXi/_PDPI/Reports/FOS_Trend_Timeline/dataSource',
			'outputFileSheet':['Sheet 1'],
			'outputFileName':'FOS_rtnCmc.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultantDealerKeysDF':['CONSULTANT','DEALER'],
...
#-----------------------------------------------------------------------------------------
		'2_rtnDealer.csv':{
			...
			'outputFileDir':'//hke.local/hma/Dept/Customer_Satisfaction/Service Business Development/Service Business Improvement/_Programs and Vendors/MSXi/_PDPI/Reports/FOS_Trend_Timeline/dataSource',
			'outputFileSheet':['Sheet 1'],
			'outputFileName':'FOS_rtnDealer.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultantDealerKeysDF':['CONSULTANT','DEALER'],
...
#-----------------------------------------------------------------------------------------
		'3_roCpCt.csv':{
			...
			'outputFileSheet':['Sheet 1'],
			##CHANGE
			'outputFileName':'FOS_roCpCt.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultantDealerKeysDF':['CONSULTANT','DEALER'],
...
#-----------------------------------------------------------------------------------------
		'3_roCpDol.csv':{
			...
			'outputFileSheet':['Sheet 1'],
			##CHANGE
			'outputFileName':'FOS_roCpDol.xlsx',
			'inputFileDir':os.getcwd(),
			'oldDT':'YYmmmmDD',
			'newDT':'yyyyMM',
			'consultantDealerKeysDF':['CONSULTANT','DEALER'],
